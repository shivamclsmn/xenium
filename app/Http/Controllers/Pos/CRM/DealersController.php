...
class DealersController extends Controller
{
    ...
    {
        //
        $customers = Customers::where('isDealer',1)->get();
        return view('pos.crm.dealers', compact('customers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('pos.crm.dealers'));
    }
    ...
    public function show(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = Customers::where('isDealer',1)->latest()->get();
